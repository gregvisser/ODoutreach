...
Started 2026-08-31 15:59:07, took about 16 minutes.
...
* When you finish, update this item's row in `.bidlow/relay/QUEUE.md` to
  `DONE 195`, or back to `TODO` with a note if you could not do it.
...
Markdown bold around it is fine - `| **DONE 195 - ...** |` reads correctly.
...
* Finished it -> `DONE 195 - <what you did, and the proof>`
* Did some of it -> `PARTIAL 195 - <what is done, what is left>`. PARTIAL
...
I'll stop polling and wait for the scheduled wakeup to fire.
