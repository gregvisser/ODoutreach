...
Started 2026-08-30 18:01:54, took about 12.5 minutes.
...
* When you finish, update this item's row in `.bidlow/relay/QUEUE.md` to
  `DONE 155`, or back to `TODO` with a note if you could not do it.
...
Markdown bold around it is fine - `| **DONE 155 - ...** |` reads correctly.
...
* Finished it -> `DONE 155 - <what you did, and the proof>`
* Did some of it -> `PARTIAL 155 - <what is done, what is left>`. PARTIAL
...
CI is running in the background; I'll resume once it finishes (or the fallback wakeup fires) to merge PR #451 and close out row 114.
