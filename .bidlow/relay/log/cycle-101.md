...
Started 2026-08-29 14:29:52, took about 45 minutes.
...
* When you finish, update this item's row in `.bidlow/relay/QUEUE.md` to
  `DONE 101`, or back to `TODO` with a note if you could not do it.
...
Markdown bold around it is fine - `| **DONE 101 - ...** |` reads correctly.
...
* Finished it -> `DONE 101 - <what you did, and the proof>`
* Did some of it -> `PARTIAL 101 - <what is done, what is left>`. PARTIAL
