...
Started 2026-08-31 07:49:34, took about 17.8 minutes.
...
* When you finish, update this item's row in `.bidlow/relay/QUEUE.md` to
  `DONE 169`, or back to `TODO` with a note if you could not do it.
...
Markdown bold around it is fine - `| **DONE 169 - ...** |` reads correctly.
...
* Finished it -> `DONE 169 - <what you did, and the proof>`
* Did some of it -> `PARTIAL 169 - <what is done, what is left>`. PARTIAL
...
Still waiting on GitHub Actions to finish CI for PR #476 (the deck-headline change) — will merge as soon as it's green.
