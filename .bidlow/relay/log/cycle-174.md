...
Started 2026-08-31 09:18:22, took about 5.3 minutes.
...
* When you finish, update this item's row in `.bidlow/relay/QUEUE.md` to
  `DONE 174`, or back to `TODO` with a note if you could not do it.
...
Markdown bold around it is fine - `| **DONE 174 - ...** |` reads correctly.
...
* Finished it -> `DONE 174 - <what you did, and the proof>`
* Did some of it -> `PARTIAL 174 - <what is done, what is left>`. PARTIAL
...
PR #483 is open with CI running. I've scheduled a check-in and also have a background poller watching the checks — whichever fires first, I'll merge once CI is green, verify the commit hash against `origin/main`, and close out row 138 as `DONE 174`.
...
sentences below into that file as row #139, status TODO.
