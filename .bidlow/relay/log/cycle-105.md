...
was stopped, along with every process it had started (10 in
...
Started 2026-08-29 19:55:27, took about 45 minutes.
...
* When you finish, update this item's row in `.bidlow/relay/QUEUE.md` to
  `DONE 105`, or back to `TODO` with a note if you could not do it.
...
Markdown bold around it is fine - `| **DONE 105 - ...** |` reads correctly.
...
* Finished it -> `DONE 105 - <what you did, and the proof>`
* Did some of it -> `PARTIAL 105 - <what is done, what is left>`. PARTIAL
